...
export default {
    ...
    // computed doesn't work, since computed'll be visited when mounted,
    ...
    methods: {
        ...
        onTouchMove(e) {
            ...
            const tmpWidth = this.touch.beginWith + delta
            const barWidth = this.$el.clientWidth - progressBtnWidth
            const progress = Math.min(1, Math.max(0, tmpWidth / barWidth))
